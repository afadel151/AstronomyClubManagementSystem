...
public partial class AstroClubDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Equipment>(entity =>
        {
            ...
            entity.Property(e => e.Status).HasDefaultValue("operational");
        ...
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetimeoffset())");
            entity.Property(e => e.Status).HasDefaultValue("proposed");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetimeoffset())");
        ...
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetimeoffset())");
            entity.Property(e => e.PublicationStatus).HasDefaultValue("raw");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetimeoffset())");
        ...
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetimeoffset())");
            entity.Property(e => e.Timesys).HasDefaultValue("UTC");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetimeoffset())");
        ...
        modelBuilder.Entity<Project>(entity =>
        {
            ...
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetimeoffset())");
            entity.Property(e => e.Visibility).HasDefaultValue("members_only");
