...
namespace Data.Migrations
{
    ...
    partial class AstroClubDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.DataproductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Entities.ImageRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Entities.Equipment", b =>
                {
                    b.HasOne("Data.Entities.EquipmentCategory", "Category")
                        .WithMany("Equipment")
            ...
            modelBuilder.Entity("Data.Entities.EquipmentMaintenance", b =>
                {
                    b.HasOne("Data.Entities.Equipment", "Equipment")
            ...
            modelBuilder.Entity("Data.Entities.Event", b =>
                {
                    b.HasOne("Data.Entities.EventType", "EventType")
                        .WithMany("Events")
                        .HasForeignKey("EventTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_EV_EventType");

                    b.HasOne("Data.Entities.Target", "Target")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Data.Entities.EventObservation", b =>
                {
                    ...
                    b.HasOne("Data.Entities.Observation", "Observation")
                        .WithMany("EventObservations")
            ...
            modelBuilder.Entity("Data.Entities.EventVisibility", b =>
                {
                    ...
                    b.HasOne("Data.Entities.ObservationSite", "Site")
                        .WithMany("EventVisibilities")
            ...
            modelBuilder.Entity("Data.Entities.Forecast", b =>
                {
                    b.HasOne("Data.Entities.ForecastCategory", "Category")
                        .WithMany("Forecasts")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Data.Entities.ForecastProject", b =>
                {
                    b.HasOne("Data.Entities.Forecast", "Forecast")
            ...
            modelBuilder.Entity("Data.Entities.Observation", b =>
                {
                    ...
                    b.HasOne("Data.Entities.Equipment", "Telescope")
            ...
            modelBuilder.Entity("Data.Entities.ObservationSession", b =>
                {
                    b.HasOne("Data.Entities.ObservationSessionType", "SessionType")
            ...
            modelBuilder.Entity("Data.Entities.Task", b =>
                {
                    ...
                    b.HasOne("Data.Entities.Milestone", "Milestone")
                        .WithMany("Tasks")
                        .HasForeignKey("MilestoneId")
                        .HasConstraintName("FK_TSK_Milestone");

                    b.HasOne("Data.Entities.Task", "ParentTask")
